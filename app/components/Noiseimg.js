...
const Noiseimg = ({ data }) => {
    return (
        <View style={styles.root}>
            <Image style={styles.noiseimg} source={require('../assets/images/noiseimg.jpeg')} />
            <Text style={[styles.noiseheadtxt]}>{data.line1}</Text>

            <Text style={styles.noisetxt}>{data.line2}</Text>
            <TouchableOpacity style={styles.noisebuttoncontainer}><Text style={styles.noisebutton}>Pair Device</Text></TouchableOpacity>
